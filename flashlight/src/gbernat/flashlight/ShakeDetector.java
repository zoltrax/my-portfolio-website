...
public class ShakeDetector implements SensorEventListener {
	...
	private static final int SHAKE_SLOP_TIME_MS = 750;
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (mListener != null) {
			...
			int sensivity_sk = sharedPref.getInt(Utils.getAppContext()
					.getString(R.string.shake_sensivity), 666);

			if (sensivity_sk == 666) {
				SHAKE_THRESHOLD_GRAVITY = 2.3f;
			} else {
				SHAKE_THRESHOLD_GRAVITY = (sensivity_sk * 0.11f) + 1.3f;
			}
